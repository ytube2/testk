...
OS=`uname -m`;
MYIP=$(wget -qO- ipv4.enak.gegara.ml);
...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/jhall031/testk/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/jhall031/testk/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
