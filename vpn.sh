...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/contong1/testk/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/contong1/testk/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
